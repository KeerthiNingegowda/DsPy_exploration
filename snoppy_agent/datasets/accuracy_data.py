accuracy_set = [
    ...
    },
    {
        ...
        "verify_items": ["VFV.TO current price", "RY.TO current price", "GOOGL current price", "TSM current price"],
        "tools_needed": ["get_stock_prices"]
    },
    {
        "query": "What is the current gold price and how are Canadian bank stocks doing?",
        "verify_items": ["gold price USD", "RY.TO price", "TD.TO price", "BMO.TO price"],
